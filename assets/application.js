...
$(document).ready(function() {
  // Menu
  let menuSelector = '.js-menu-link';
  let menu = {
    onMenuButtonClick: function(event) {
      event.preventDefault();

      let
        isMenuOpen = $('html').hasClass('menu-open');
    ...
    init: function() {
      $(document).on('click', menuSelector, menu.onMenuButtonClick);
    }
  };
  ...
  let ajaxify = {
    ...
    init: function() {
      ...
      $(document).on('click', '.js-cart-link, .js-keep-shopping, .js-cart-close', ajaxify.onCartButtonClick);
    }
  };
